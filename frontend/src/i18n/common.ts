const common = {
    de: {
      translation: {
        ...
        selectWeightsInfo: "Kombinationen im Überblick\nHier legen Sie fest, welche Attribut-Kombinationen bei Ihrer Bewertung eine Rolle spielen – und vor allem, wie wichtig sie Ihnen sind.\n\nDas Wichtigste zuerst:\nSetzen Sie die Priorität (Gewichtung) für jede Kombination. Was Ihnen am wichtigsten ist, bekommt die höchste Gewichtung – so steuern Sie direkt, worauf der Fokus bei der Bewertung liegt.\n\nWeitere Möglichkeiten:\nAktivieren oder deaktivieren Sie einzelne Kombinationen – nur die ausgewählten fließen später in die Bewertung ein.\n\nÜber das Info-Symbol finden Sie bei Bedarf mehr Erklärungen zu jeder Kombination.\n\nTipp:\nMit der Gewichtung bestimmen Sie die Richtung Ihrer Bewertung. Überlegen Sie gut, welche Kombinationen am meisten zählen sollen!\n\nWenn Sie zufrieden sind, geht’s direkt weiter zum nächsten Schritt.",
    ...
    en: {
      translation: {
        ...
        selectWeightsInfo: "Combinations at a glance\nHere you decide which attribute combinations play a role in your evaluation – and above all, how important they are to you.\n\nThe most important thing first:\nSet the priority (weighting) for each combination. Give the highest weighting to what matters most to you – this directly influences the focus of the evaluation.\n\nMore options:\nActivate or deactivate individual combinations – only the selected ones are included in the evaluation.\n\nUse the info icon for more explanations about each combination.\n\nTip:\nBy weighting you determine the direction of your assessment. Think carefully about which combinations should count the most!\n\nWhen you are satisfied, proceed directly to the next step.",
    ...
    fr: {
      translation: {
        ...
        selectWeightsInfo: "Aperçu des combinaisons\nIci, vous définissez quelles combinaisons d'attributs comptent dans votre évaluation – et surtout leur importance.\n\nL'essentiel en premier :\nAttribuez une priorité (pondération) à chaque combinaison. Ce qui compte le plus obtient la pondération la plus élevée – vous dirigez ainsi directement le focus de l'évaluation.\n\nAutres possibilités :\nActivez ou désactivez des combinaisons individuelles – seules celles sélectionnées seront prises en compte lors de l'évaluation.\n\nGrâce à l'icône d'information, vous trouverez au besoin plus d'explications sur chaque combinaison.\n\nAstuce :\nAvec la pondération, vous orientez votre évaluation. Réfléchissez bien aux combinaisons qui doivent compter le plus !\n\nUne fois satisfait, passez directement à l'étape suivante.",
