const common = {
    de: {
      translation: {
        ...
        selectIdeasInfo: "<p><strong>\u00dcbersicht: Ihre Ideensammlung</strong><br />Auf dieser Seite sehen Sie alle Ideen, die aktuell in Ihrer Sammlung enthalten sind.</p><p><strong>Was k\u00f6nnen Sie hier tun?</strong><br />Pr\u00fcfen Sie, ob alle Ideen vollst\u00e4ndig und korrekt \u00fcbernommen wurden. Kontrollieren Sie Namen, Beschreibungen und Attribute jeder Idee. Sie k\u00f6nnen einzelne Ideen aktivieren oder deaktivieren \u2013 ausgeschaltete Ideen werden nicht bewertet.</p><p><strong>Hinweis:</strong><br />Erg\u00e4nzen oder bearbeiten Sie Angaben, falls Sie Fehler oder L\u00fccken entdecken. \u00dcber das Info-Symbol erhalten Sie weitere Details. Die Qualit\u00e4t der Bewertung h\u00e4ngt ma\u00dfgeblich von der Vollst\u00e4ndigkeit und Korrektheit dieser Angaben ab. Nutzen Sie diese \u00dcbersicht, um Ihre Datengrundlage zu optimieren!</p><p>Sind Sie zufrieden, gehen Sie zum n\u00e4chsten Schritt und w\u00e4hlen die Bewertungskriterien aus.</p>",
        ...
        selectWeightsInfo: "<p><strong>Kombinationen im Überblick</strong></p><p>Hier legen Sie fest, welche Attribut-Kombinationen bei Ihrer Bewertung eine Rolle spielen – und vor allem, wie wichtig sie Ihnen sind.</p><p><strong>Das Wichtigste zuerst:</strong></p><p>Setzen Sie die Priorität (Gewichtung) für jede Kombination. Was Ihnen am wichtigsten ist, bekommt die höchste Gewichtung – so steuern Sie direkt, worauf der Fokus bei der Bewertung liegt.</p><p><strong>Weitere Möglichkeiten:</strong></p><ul><li>Aktivieren oder deaktivieren Sie einzelne Kombinationen – nur die ausgewählten fließen später in die Bewertung ein.</li><li>Über das Info-Symbol finden Sie bei Bedarf mehr Erklärungen zu jeder Kombination.</li></ul><p><strong>Tipp:</strong> Mit der Gewichtung bestimmen Sie die Richtung Ihrer Bewertung. Überlegen Sie gut, welche Kombinationen am meisten zählen sollen!</p><p>Wenn Sie zufrieden sind, geht’s direkt weiter zum nächsten Schritt.</p>",
       introText: "<p>Willkommen auf der Bewertungsmatrix!</p><p>Mit dieser Webanwendung können Sie unterschiedlichste Ideen oder Projekte schnell, flexibel und nachvollziehbar bewerten und vergleichen. Sie laden einfach Ihre Ideensammlung hoch (oder nutzen unsere Vorlage), legen eigene Bewertungskriterien und Gewichtungen fest und erhalten direkt eine transparente, verständliche Auswertung als Ranking und Diagramm.</p><p><strong>Was erwartet Sie?</strong></p><ul><li>Eigene Ideen oder Vorlagen importieren</li><li>Individuelle Bewertungskriterien festlegen und gewichten</li><li>Alle Berechnungen nachvollziehen und Ergebnisse exportieren</li><li>Flexible Anpassung an verschiedenste Themen und Fragestellungen</li><li>Intuitive Bedienung: keine IT-Kenntnisse notwendig</li></ul><p>Sie werden Schritt für Schritt durch den Prozess geführt:</p><ol><li>Auswahl und Import der Ideensammlung</li><li>Auswahl und Gewichtung der Bewertungskriterien</li><li>Start der Bewertung und Einsicht der Ergebnisse</li><li>Exportmöglichkeiten und Detailauswertung</li></ol><p>Klicken Sie auf \u201eStart\u201c, um zu beginnen \u2013 oder informieren Sie sich \u00fcber Hilfe und Beispiele oben im Men\u00fc.</p><p>Viel Erfolg mit der Bewertungsmatrix!</p>",
        ...
        summaryDescription: "<strong>\u00dcberblick vor dem Start</strong><br/>Kontrollieren Sie, ob <strong>Ideensammlung</strong>, <strong>Kombinationen</strong> und <strong>Gewichtungen</strong> stimmen.<br/>Fehler k\u00f6nnen Sie durch Zur\u00fcckgehen korrigieren.<br/><br/><strong>Wichtig:</strong> Nach Klick auf <strong>\u201eErgebnisse anzeigen\u201c</strong> sind keine \u00c4nderungen mehr m\u00f6glich. Mit <strong>\u201eBerechnen\u201c</strong> starten Sie die Auswertung. Erst wenn diese abgeschlossen ist, erscheint der Button <strong>\u201eErgebnisse anzeigen\u201c</strong>.<br/><br/>Nehmen Sie sich Zeit \u2013 so stellen Sie sicher, dass Ihre Auswertung auf den richtigen Daten basiert!",
    ...
    en: {
      translation: {
        ...
        selectIdeasInfo: "<p><strong>Overview: Your idea collection</strong><br />On this page you can see all ideas currently contained in your collection.</p><p><strong>What can you do here?</strong><br />Check that all ideas were imported completely and correctly. Verify the name, description and attributes of each idea. Activate or deactivate individual ideas \u2013 disabled ideas will not be evaluated.</p><p><strong>Note:</strong><br />Add or edit information if you notice errors or gaps. Use the info icon for more details. The quality of the evaluation depends heavily on the completeness and correctness of these details. Use this overview to optimise your data set!</p><p>Once you are satisfied with the idea collection, proceed to the next step and choose the evaluation criteria.</p>",
        ...
        selectWeightsInfo: "<p><strong>Combinations at a glance</strong></p><p>Here you decide which attribute combinations play a role in your evaluation – and above all, how important they are to you.</p><p><strong>The most important thing first:</strong></p><p>Set the priority (weighting) for each combination. Give the highest weighting to what matters most to you – this directly influences the focus of the evaluation.</p><p><strong>More options:</strong></p><ul><li>Activate or deactivate individual combinations – only the selected ones are included in the evaluation.</li><li>Use the info icon for more explanations about each combination.</li></ul><p><strong>Tip:</strong> By weighting you determine the direction of your assessment. Think carefully about which combinations should count the most!</p><p>When you are satisfied, proceed directly to the next step.</p>",
    ...
    fr: {
      translation: {
        ...
        selectIdeasInfo: "<p><strong>Vue d'ensemble&nbsp;: votre collecte d'idées</strong><br />Cette page présente toutes les idées actuellement enregistrées.</p><p><strong>Que pouvez-vous faire ici&nbsp;?</strong><br />Vérifiez que toutes les idées ont été importées correctement. Contrôlez le nom, la description et les attributs de chaque idée. Activez ou désactivez les idées inutiles \u2013 celles désactivées ne seront pas évaluées.</p><p><strong>Remarque&nbsp;:</strong><br />Complétez ou modifiez les informations en cas d'erreurs ou de lacunes. L'icône d'information fournit d'autres détails. La qualité de l'évaluation dépend fortement de l'exhaustivité et de l'exactitude des données. Utilisez donc cette vue pour optimiser votre base&nbsp;!</p><p>Lorsque vous êtes satisfait de la collecte, passez à l'étape suivante et choisissez les critères d'évaluation.</p>",
        ...
        selectWeightsInfo: "<p><strong>Aperçu des combinaisons</strong></p><p>Ici, vous définissez quelles combinaisons d'attributs comptent dans votre évaluation – et surtout leur importance.</p><p><strong>L'essentiel en premier&nbsp;:</strong></p><p>Attribuez une priorité (pondération) à chaque combinaison. Ce qui compte le plus obtient la pondération la plus élevée – vous dirigez ainsi directement le focus de l'évaluation.</p><p><strong>Autres possibilités&nbsp;:</strong></p><ul><li>Activez ou désactivez des combinaisons individuelles – seules celles sélectionnées seront prises en compte lors de l'évaluation.</li><li>Grâce à l'icône d'information, vous trouverez au besoin plus d'explications sur chaque combinaison.</li></ul><p><strong>Astuce&nbsp;:</strong> Avec la pondération, vous orientez votre évaluation. Réfléchissez bien aux combinaisons qui doivent compter le plus&nbsp;!</p><p>Une fois satisfait, passez directement à l'étape suivante.</p>",
