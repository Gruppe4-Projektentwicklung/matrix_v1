  ...
  resources: {
    de: {
      translation: {
        ...
        noName: "Kein Name",
        showDescription: "Ideenbeschreibung anzeigen",
        ...
        optionDataReleaseOpen: "Daten eingeben (anonym)",
        optionDataReleaseAnonym: "Nur Nutzungsverhalten speichern",
        optionDataReleaseNone: "Gar nichts speichern",

        currentIdeaCollection: "Aktuelle Ideensammlung",
        currentCombinationCollection: "Aktuelle Kombinationssammlung",
        uploadErrorInvalidFile: "Bitte eine Excel-Datei (.xlsx) hochladen.",
    ...
    en: {
      translation: {
        ...
        noName: "No name",
        showDescription: "Show idea description",
        ...
        optionDataReleaseOpen: "Enter data (anonymous)",
        optionDataReleaseAnonym: "Only save usage behavior",
        optionDataReleaseNone: "Save nothing",
    ...
    fr: {
      translation: {
        ...
        selectCollection: "Sélectionner une collection d'idées",
        selectCombination: "Sélectionner une collection de combinaisons",
        ...
        noName: "Pas de nom",
        showDescription: "Afficher la description de l'idée",
        combination: "Combinaison",
        value: "Valeur",
        noDetails: "Aucun détail disponible",

        optionsTitle: "Options d'évaluation",
        optionConsiderRound1: "Prendre en compte le tour 1",
        optionConsiderRound2: "Prendre en compte le tour 2",
        ...
        optionDataReleaseOpen: "Entrer les données (anonymes)",
        optionDataReleaseAnonym: "Enregistrer uniquement le comportement d'utilisation",
        optionDataReleaseNone: "Ne rien enregistrer",

        currentIdeaCollection: "Collection d'idées actuelle",
        currentCombinationCollection: "Collection de combinaisons actuelle",
        uploadErrorInvalidFile: "Veuillez télécharger un fichier Excel (.xlsx).",
        ...
        submitWithoutData: "Envoyer sans information",
